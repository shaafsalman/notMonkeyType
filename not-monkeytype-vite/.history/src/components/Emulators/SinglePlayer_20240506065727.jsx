...
const SinglePlayer = () => {
    ...
    return (
        <div className="singlePlayer">
            ...
            {!showOptions ? (
                <button className="px-4 ml-4 md:ml-10 py-2 flex items-center justify-center h-10 w-24 text-base text-white bg-purple-700 rounded-lg border border-purple-700 transition duration-300 hover:bg-indigo-700" onClick={toggleOptions}>
                    Expand
                </button>
            ) : (
                <>
                    ...
                    {testStarted ? (
                        <button className="px-4 py-2 ml-4 md:ml-10 flex items-center justify-center h-10 w-24 text-base text-white bg-purple-700 rounded-lg border border-purple-700 transition duration-300 hover:bg-indigo-700" onClick={endTest}>
                            Stop
                        </button>
                    ) : (
                        <button className="px-4 ml-4 md:ml-10 py-2 flex items-center justify-center h-10 w-24 text-base text-white bg-purple-700 rounded-lg border border-purple-700 transition duration-300 hover:bg-indigo-700" onClick={startTest}>
                            Start
                        </button>
                    )}
                </>
