...
const SinglePlayer = () => {
    ...
    {testStarted ? (
        ...
        <button className="px-5 py-2 flex items-center justify-center h-10 w-24 text-base text-white bg-purple-700 rounded-lg border border-purple-700 transition duration-300 hover:bg-indigo-700" onClick={startTest}>
            Start
        </button>
    )}
</nav>
