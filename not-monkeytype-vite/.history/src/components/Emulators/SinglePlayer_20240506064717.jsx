    ...
    return (
        <div className="singlePlayer">
            <div className="keyBoardContainer"><Keyboard/></div>
             ...
             <nav className="flex justify-between items-center px-10 py-4 bg-gradient-to-br from-purple-500 to-indigo-600 text-white w-80 min-h-16 rounded-lg shadow-md transition duration-300">
