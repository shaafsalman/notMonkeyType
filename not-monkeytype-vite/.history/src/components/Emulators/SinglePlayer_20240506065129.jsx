...
const SinglePlayer = () => {
    ...
    return (
       ...
       <nav className="flex mx-60 mt-5 justify-between items-center px-10 py-2 bg-gradient-to-br from-purple-500 to-indigo-600 text-white w-max min-h-16 rounded-lg shadow-md transition duration-300">
    ...
    <h1 className="text-2xl px-20 font-bold">notMonkeyType</h1>
    <div className="mode text-l">Mode: SinglePlayer</div>
