      ...
      <div className="p-4">
        ...
        <div className="mt-4">
          ...
          <div className="flex justify-center mt-4">
            <a href="#" className="bg-green-1000 text-white px-4 py-2 rounded-full text-sm font-semibold hover:bg-purple-600 transition-colors duration-300">Contact via WhatsApp</a>
          </div>
        </div>
      </div>
    </motion.div>
