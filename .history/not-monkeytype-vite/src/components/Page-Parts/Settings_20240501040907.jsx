        ...
        <div className="px-60 py-4">
          <div className="mx-2 min-h-screen max-w-screen-xl sm:mx-8 xl:mx-40">
            <div className="grid grid-cols-12 pt-3 sm:grid-cols-12 ">
              ...
              <div className="px-60 col-span-12 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
                <div className="pt-4">
                  <div className="font-bold text-4xl mb-2 px-60 ">Game Settings</div>
                </div>
