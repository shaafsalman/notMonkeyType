            ...
            <div class="flex flex-col lg:w-max sm:flex-row">
              ...
              <div class="lg:w-max sm:w-1/2 pl-4">
                ...
                <div class="flex flex-col items-start">
                  ...
                  <input type="password" id="new-password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} class="w-full border-gray-300 bg-white py-2 px-4 text-base text-gray-700 placeholder-gray-400 focus:outline-none mb-4 rounded-lg ml-20" />
                </div>
              </div>
            </div>
