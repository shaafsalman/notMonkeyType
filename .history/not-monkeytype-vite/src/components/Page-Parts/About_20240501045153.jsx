...
import member1Pic from '../../assets/member1.gif'; // Import member profile pictures (GIF format)
import member2Pic from '../../assets/member2.jpg'; // Import member profile pictures (JPEG format)
import member3Pic from '../../assets/member3.gif'; // Import member profile pictures (GIF format)
import member4Pic from '../../assets/member4.jpg'; // Import member profile pictures (JPEG format)
