    ...
    <>
      {deleted ? (
        ...
        <div className="profileMain">
          <div className="flex justify-center items-center h-full">
  <div className="max-w-screen-md mx-auto my-20 overflow-hidden shadow-lg bg-gradient-to-br from-purple-500 to-indigo-600 rounded-lg">
    <div className="px-6 py-4">
      <div className="font-bold text-4xl mb-2 text-center">Profile</div>
      ...
      <div className="flex flex-col space-y-2">
        <label htmlFor="current-password">
          ...
          <input type="password" id="current-password" value={currentPassword} onChange={(e) => setCurrentPassword(e.target.value)} className="w-full appearance-none border-gray-300 bg-white py-2 px-4 text-base text-gray-700 placeholder-gray-400 focus:outline-none" />
        </label>
        <label htmlFor="new-password">
          <span className="text-sm text-gray-500">New Password</span>
          <input type="password" id="new-password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} className="w-full appearance-none border-gray-300 bg-white py-2 px-4 text-base text-gray-700 placeholder-gray-400 focus:outline-none" />
        </label>
      </div>
      <button className="mt-4 rounded-lg bg-indigo-900 px-4 py-2 text-white" onClick={handleChangePassword}>Save Password</button>
