...
import InputButtonCard from './inputButtonCard';
  ...
  return (
    ...
    {/* {showVerificationInput && (
      <div className="verification-section">
        <FontAwesomeIcon icon={faLock} className="verification-icon" />
        ...
        <div className="verificationInput">
          ...
          <div className="verificationBtn"></div>
          <input type="button" onClick={handleVerifyEmail} value="Verify Email" />
      </div>
    )} */}
  </div>
