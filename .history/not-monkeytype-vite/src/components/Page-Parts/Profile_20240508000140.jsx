...
const Profile = () => {
  ...
  <div class="w-full max-w-4xl rounded-lg mx-4 my-20 h-110 overflow-hidden shadow-lg bg-transparent backdrop-filter backdrop-blur-md backdrop-saturate-150 bg-opacity-10">
      <div class="px-6 py-4 ">
