...
const Profile = () => {
  ...
  <div class="flex justify-center items-center h-full">
    <div class="w-full max-w-5xl rounded-lg mx-4 my-5 overflow-hidden shadow-lg bg-gradient-to-br from-purple-500 to-indigo-600">
      <div class="px-6 py-4">
        <div class="max-h-screen sm:px-8 xl:px-12">
          <div class="grid grid-rows-2 sm:grid-cols-2">
            ...
            <div class="flex flex-col sm:flex-row items-stretch">
              <div class="sm:w-full pr-4 flex-grow">
                ...
                <div class="flex flex-col items-start flex-grow">
                  ...
                  <button class="rounded-lg bg-indigo-900 px-4 py-2 text-white w-full">Save Password</button>
                </div>
              </div>
            </div>
            <hr class="mt-4 mb-8 border-0 bg-white" />
            <div class="mb-10">
              ...
              <button class="rounded-lg bg-red-900 px-4 py-2 text-white w-full">Delete Account</button>
            </div>
          </div>
        </div>
      </div>
