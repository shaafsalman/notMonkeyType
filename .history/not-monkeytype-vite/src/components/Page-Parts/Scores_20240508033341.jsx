  ...
  <tbody>
    {userGameSessions.map((session, index) => (
      <tr key={index} className={index % 2 === 0 ? "" : ""}>
        ...
        <td className="py-2 text-center text-2xl">{name}</td>
        <td className="py-2 text-center text-2xl ">{session.wpm}</td>
        <td className="py-2 text-center text-2xl">{session.accuracy}%</td>
        <td className="py-2 text-center text-2xl">{formatDate(session.createdAt)}</td>
        <td className="py-2 text-center text-2xl">{session.sessionTime}</td>
        <td className="py-2 text-center text-2xl">{session.score}</td>
      </tr>
    ))}
  </tbody>
</table>
