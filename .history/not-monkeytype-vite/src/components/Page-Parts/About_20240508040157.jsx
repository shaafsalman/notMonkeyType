...
const About = () => {
  return (
    <div className="bg-gray-100 py-16  bg-transparent backdrop-filter backdrop-blur-md backdrop-saturate-150 bg-opacity-20 transition duration-500 transform hover:scale-105">
      <div className="max-w-6xl mx-auto px-2 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2">
          {/* Team Section */}
          <div>
            <h2 className="text-4xl font-bold text-gray-900 mb-8">Team</h2>
          ...
          {/* Project Section */}
          <div>
            <h2 className="text-4xl font-bold text-gray-900 mb-8">Project</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <ProjectCard
                name="notMonkeyType"
        ...
        <h2 className="text-4xl font-bold text-gray-900 mb-8 mt-16">Team Members</h2>
