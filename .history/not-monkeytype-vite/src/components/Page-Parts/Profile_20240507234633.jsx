          ...
          <div class="w-full max-w-4xl rounded-lg mx-4 my-5 overflow-hidden shadow-lg bg-gradient-to-br from-purple-500 to-indigo-600">
            <div class="px-6 py-4">
              <div class="max-h-screen sm:px-8 xl:px-12">
                <div class="grid grid-rows-3 sm:grid-cols-2">
                  <div class="pt-4">
                  ...
                  <div class="flex flex-col sm:flex-row">
                    <div class="sm:w-full">
                      ...
                      <button className="w-full mt-2 rounded-lg bg-indigo-900 px-4 py-2 text-white" onClick={handleChangePassword}>Save Password</button>
                    </div>
                  </div>
                  <hr class="mt-4 mb-8 border-0 bg-white" />
                  <div class="mb-10">
                    ...
                    <button class="w-full rounded-lg bg-red-900 px-4 py-2 text-white">Delete Account</button>
                  </div>
                </div>
              </div>
            </div>
