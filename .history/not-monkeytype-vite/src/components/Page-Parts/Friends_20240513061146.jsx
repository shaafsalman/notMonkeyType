      ...
      <div className="px-6 py-4">
        <div className="font-bold text-4xl text-white mb-6">Friends Battles</div>
          <div key={index} className="mb-8">
            <div className="text-2xl text-white font-bold mb-2">Battle {index + 1}</div>
            <div className="grid grid-cols-6 gap-4">
              <div className="col-span-3 bg-transparent border border-gray-800 rounded-lg py-3 px-4">
                ...
                <p className="text-white">{battle.player1.email}</p>
              </div>
              <div className="col-span-3 bg-transparent border border-gray-800 rounded-lg py-3 px-4">
                <p className="text-gray-300 font-bold">Player</p>
                <p className="text-white">{battle.player2.email} {determineWinner() === battle.player1.email ? <FaTrophy className="inline text-yellow-500" /> : null}</p>
              </div>
              <div className="bg-transparent border border-gray-800 rounded-lg py-3 px-4">
                <p className="text-gray-300 font-bold">WPM</p>
                <p className="text-white text-center">{Math.round(battle.player1.wpm)}</p>
              </div>
              <div className="bg-transparent border border-gray-800 rounded-lg py-3 px-4">
                <p className="text-gray-300 font-bold">Accuracy</p>
                <p className="text-white text-center">{Math.round(battle.player1.accuracy)}</p>
              </div>
              <div className="bg-transparent border border-gray-800 rounded-lg py-3 px-4">
                <p className="text-gray-300 font-bold">Overall Score</p>
                <p className="text-white text-center">{Math.round(computeOverallScore(battle.player1))}</p>
              </div>
              <div className="bg-transparent border border-gray-800 rounded-lg py-3 px-4">
                <p className="text-gray-300 font-bold">WPM</p>
                <p className="text-white text-center">{Math.round(battle.player2.wpm)}</p>
              </div>
              <div className="bg-transparent border border-gray-800 rounded-lg py-3 px-4">
                <p className="text-gray-300 font-bold">Accuracy</p>
                <p className="text-white text-center">{Math.round(battle.player2.accuracy)}</p>
              </div>
              <div className="bg-transparent border border-gray-800 rounded-lg py-3 px-4">
                <p className="text-gray-300 font-bold">Overall Score</p>
                <p className="text-white text-center">{Math.round(computeOverallScore(battle.player2))} {determineWinner() === battle.player2.email ? <FaTrophy className="inline text-yellow-500" /> : null}</p>
              </div>
            </div>
          </div>
        ))}
