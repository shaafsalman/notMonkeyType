...
const Scores = () => {
  ...
  return (
        <div className="max-w-screen-xl rounded-lg ml-10 my-20 mr-30 ml-30	 overflow-hidden shadow-lg bg-gradient-to-br from-purple-500 to-indigo-600">
        <div className="px-6 py-10 mr-20">
          <div className="font-bold text-xl text-white mb-2">Leaderboard</div>
        <div className="px- py-10">
          <div className="font-bold text-xl text-white mb-2">Scores</div>
