    ...
    <nav className="bg-gradient-to-br from-purple-500 to-indigo-600 lg:rounded-lg lg:my-12 lg:mx-20  z-10">
        ...
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="hidden lg:block lg:ml-6">
            <div className="flex space-x-4">
              <Link to="/Home/gamemenu" className={`text-white hover:'bg-indigo-800' hover:text-white rounded-md px-3 py-2 text-lg font-medium ${location.pathname === '/Home/gameenu' ? 'bg-indigo-800' : ' hover:bg-indigo-900 hover:text-white'}`${location.pathname === '/Home/gameenu' ? 'bg-indigo-800' : ' hover:bg-indigo-900 hover:text-white`}>
      ...
      <div className={`${isOpen ? 'block' : 'hidden'} lg:hidden z-20`} id="mobile-menu">
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <Link to="/Home/about" className="text-white hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
            <FaInfoCircle className="inline-block mr-1" />
            About
          </Link>
