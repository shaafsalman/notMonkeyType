    ...
    <div className="friends-container max-w-screen-lg mx-auto rounded-lg overflow-hidden shadow-lg bg-gradient-to-br from-purple-500 to-indigo-600">
      <div className="px-8 py-10">
        ...
        <div className="flex pr-2 items-center mb-8">
          <button onClick={addFriend} className=z"bg-indigo-800 hover:bg-indigo-900 text-white py-3 px-8 rounded-lg transition duration-300 focus:outline-none">Add Friend</button>
