        ...
        <div class="max-h-screen sm:px-8 xl:px-12">
          <div class="grid grid-rows-2 sm:grid-cols-2">
            ...
            <div class="flex flex-col sm:flex-row mt-10">
              <div class="w-full sm:w-1/2 pr-4 lg:w-max">
              ...
              <div class="w-full sm:w-1/2 pl-4 lg:w-max">
            ...
            <div class="flex justify-center sm:justify-start mt-6">
              <button className="w-full sm:w-auto rounded-lg bg-indigo-900 px-4 py-2 text-white" onClick={handleChangePassword}>Save Password</button>
            </div>
            ...
            <div class="mb-10 mt-6">
              ...
              <div class="flex flex-col sm:flex-row items-center">
                ...
                <button class="ml-0 sm:ml-4 rounded-lg bg-red-900 px-4 py-2 text-white">Delete Account</button>
              </div>
            </div>
          </div>
        </div>
