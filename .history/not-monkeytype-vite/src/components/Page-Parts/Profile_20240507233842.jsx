        ...
        <div class="max-h-screen sm:px-8 xl:px-12">
          <div class="grid grid-rows-2 sm:grid-cols-2">
            ...
            <div class="flex flex-col lg:w-max sm:flex-row">
              ...
              <div class="lg:w-max sm:w-1/2 pl-4 mt-10">
              ...
              <button className="h-10 w-40 mt-16 ml-16 rounded-lg bg-indigo-900  text-white " onClick={handleChangePassword}>Save Password</button>
