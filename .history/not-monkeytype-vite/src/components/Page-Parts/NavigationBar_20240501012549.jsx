        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="hidden sm:block">
            <ul className="flex space-x-4">
              <li><Link to="/Leaderboard" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-xlg font-medium">Leaderboard</Link></li>
              <li><Link to="/PersonalScores" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Scores</Link></li>
              <li><Link to="/settings" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Settings</Link></li>
              <li><Link to="/about" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">About</Link></li>
              <li><Link to="/Profile" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Profile</Link></li>
            </ul>
          </div>
          <div className="flex items-center">
