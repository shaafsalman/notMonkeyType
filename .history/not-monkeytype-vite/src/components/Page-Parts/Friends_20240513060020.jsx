...
const Friends = () => {
  ...
  const computeOverallScore = (player) => {
    return player.wpm + player.accuracy + player.score;
  };
    ...
    <div className="max-w-screen-xl rounded-lg mx-auto mt-20 mb-40 overflow-hidden shadow-lg bg-transparent backdrop-filter backdrop-blur-md backdrop-saturate-150 bg-opacity-20 transition duration-500 transform hover:scale-105">
      <div className="px-6 py-4">
        ...
        <table className="text-white text-lg w-full">
          ...
          <tbody>
            <tr>
              <td className="text-left">{friendBattles.player1.email}</td>
              <td className="text-center">{friendBattles.player1.wpm}</td>
              <td className="text-center">{friendBattles.player1.accuracy}</td>
              <td className="text-center">{friendBattles.player1.score}</td>
              <td className="text-center">{computeOverallScore(friendBattles.player1)}</td>
            </tr>
            <tr>
              <td className="text-left">{friendBattles.player2.email}</td>
              <td className="text-center">{friendBattles.player2.wpm}</td>
              <td className="text-center">{friendBattles.player2.accuracy}</td>
              <td className="text-center">{friendBattles.player2.score}</td>
              <td className="text-center">{computeOverallScore(friendBattles.player2)}</td>
            </tr>
          </tbody>
        </table>
