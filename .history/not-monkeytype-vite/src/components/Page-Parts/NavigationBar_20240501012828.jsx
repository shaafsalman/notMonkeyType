...
const NavigationBar = () => {
  ...
  return (
    <nav className="bg-gray-800">
      <div className="mx-auto max-w-12xl px-2 sm:px-6 lg:px-18">
        <div className="relative flex h-20 items-center justify-between my-10 m-10">
          ...
          <div className="hidden sm:block">
            <ul className="flex space-x-4">
              ...
              <li><Link to="/Profile" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-lg font-medium">Profile</Link></li>
            </ul>
          </div>
          <div className="flex items-center">
