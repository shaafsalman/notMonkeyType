...
const Profile = () => {
  ...
  <div class="flex justify-center items-center h-full">
    <div class="w-full max-w-4xl rounded-lg mx-4 my-20 overflow-hidden shadow-lg bg-gradient-to-br from-purple-500 to-indigo-600">
      <div class="px-6 py-4">
        <div class="min-h-screen sm:px-8 xl:px-12">
          <div class="grid grid-rows-2 sm:grid-cols-2 h-20">
            <div class="pt-4">
