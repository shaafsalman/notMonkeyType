...
const Friends = () => {
  ...
  return (
    <div className="max-w-screen-xl rounded-lg mx-auto mt-20 mb-30 overflow-hidden shadow-lg bg-transparent backdrop-filter backdrop-blur-md backdrop-saturate-150 bg-opacity-20 transition duration-500 transform hover:scale-105">
