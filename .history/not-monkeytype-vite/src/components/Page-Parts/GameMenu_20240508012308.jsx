    ...
    <div className="gameMenu flex">
       ...
       <div className="menu">
        <div className="flex justify-start  mx-20 my-10 items-center h-full"> 
          ...
          <div className="max-w-lg-40 rounded-lg overflow-hidden shadow-lg bg-transparent backdrop-filter backdrop-blur-md backdrop-saturate-150 bg-opacity-20 transition duration-500 transform hover:scale-105">
