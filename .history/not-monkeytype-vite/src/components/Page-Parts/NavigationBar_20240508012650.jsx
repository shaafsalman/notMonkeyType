        ...
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="hidden lg:block lg:ml-6">
            <div className="flex space-x-4">
              <Link to="/Home/gamemenu" className={`text-white hover:'bg-indigo-800' hover:text-white rounded-md px-3 py-2 text-lg font-medium ${location.pathname === '/Home/gamemenu' or ? 'bg-indigo-800' : ' hover:bg-indigo-900 hover:text-white'}`}>
