...
const Profile = () => {
  ...
  <div class="flex justify-center items-center h-full">
    <div class="w-full max-w-4xl h-max rounded-lg mx-4 my-5 overflow-hidden shadow-lg bg-gradient-to-br from-purple-500 to-indigo-600">
      <div class="px-6 py-4">
        <div class="max-h-screen sm:px-8 xl:px-12">
          <div class="grid grid-rows-2 sm:grid-cols-2">
            ...
            <div class="flex flex-col sm:flex-row mt-10">
              ...
              <button class="w-full sm:w-auto mt-4 sm:mt-0 ml-0 sm:ml-4 rounded-lg bg-indigo-900 px-4 py-2 text-white" onClick={handleChangePassword}>Save Password</button>
            </div>
            <hr class="mt-10 mb-8 border-0 bg-white" />
            <div class="mb-10 mt-10">
              <p class="py-2 text-xl font-semibold text-white">Delete Account</p>
              <div class="flex flex-col sm:flex-row items-center">
                <p class="text-white mb-4 sm:mb-0 sm:mr-4">Deleting your account will permanently remove all data associated with it.</p>
