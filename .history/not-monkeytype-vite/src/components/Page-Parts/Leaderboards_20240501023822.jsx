...
const Leaderboards = () => {
  ...
  return (
    <div className="leaderboard-container">
      <div className="max-w-screen-xl rounded-lg overflow-hidden shadow-lg bg-gradient-to-br from-purple-500 to-indigo-600 transition duration-500 transform hover:scale-105">
