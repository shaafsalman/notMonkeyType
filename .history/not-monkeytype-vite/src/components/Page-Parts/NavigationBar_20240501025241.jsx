      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="hidden lg:block lg:ml-6">
            ...
            <Link to="/Leaderboards" className={`text-white hover:bg-indigo-800 hover:text-white rounded-md px-3 py-2 text-lg font-medium ${location.pathname === '/Leaderboards' ? 'bg-indigo-800' : 'hover:bg-purple-900 hover:text-white'}`}>Leaderboard</Link>
            <Link to="/Friends" className={`text-white hover:bg-indigo-800 hover:text-white rounded-md px-3 py-2 text-lg font-medium ${location.pathname === '/Friends' ? 'bg-indigo-800' : 'hover:bg-purple-900 hover:text-white'}`}>Friends</Link>
            <Link to="/PersonalScores" className={`text-white hover:bg-indigo-800 hover:text-white rounded-md px-3 py-2 text-lg font-medium ${location.pathname === '/PersonalScores' ? 'bg-indigo-800' : 'hover:bg-purple-900 hover:text-white'}`}>Scores</Link>
            <Link to="/settings" className={`text-white hover:bg-indigo-800 hover:text-white rounded-md px-3 py-2 text-lg font-medium ${location.pathname === '/settings' ? 'bg-indigo-800' : 'hover:bg-purple-900 hover:text-white'}`}>Settings</Link>
            <Link to="/about" className={`text-white hover:bg-indigo-800 hover:text-white rounded-md px-3 py-2 text-lg font-medium ${location.pathname === '/about' ? 'bg-indigo-800' : 'hover:bg-purple-900 hover:text-white'}`}>About</Link>
            <Link to="/Profile" className={`text-white hover:bg-indigo-800 hover:text-white rounded-md px-3 py-2 text-lg font-medium ${location.pathname === '/Profile' ? 'bg-indigo-800' : 'hover:bg-purple-900 hover:text-white'}`}>Profile</Link>
