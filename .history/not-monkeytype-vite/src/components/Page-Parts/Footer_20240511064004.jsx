...
const Footer = () => {
  return (
    <footer class="bg-transparent backdrop-filter backdrop-blur-md backdrop-saturate-150 bg-opacity-20  lg:grid lg:grid-cols-5 mt-5">
    ...
    <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
      <div>
        ...
        <ul class="mt-8 space-y-1 text-sm text-gray-700">
          <li>Contact Us At</li>
          <a href="#" class="block text-sm font-medium text-gray-900 hover:opacity-75 sm:text-2xl">
            notmonkeytype@gmail.com
          </a>
        </ul>
    ...
    <div class="mt-12 border-t border-gray-100 pt-12">
      <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <p class="mt-8 text-xs text-gray-500 sm:mt-0">
          &copy; 2024. ViaEyes. All rights reserved.
        </p>
      </div>
    </div>
  </div>
