...
const Scores = () => {
  ...
  return (
        <div className="max-w-screen-xl rounded-lg ml-10 my-20	 overflow-hidden shadow-lg bg-gradient-to-br from-purple-500 to-indigo-600">
        <div className="px-6 py-10 mr-120">
