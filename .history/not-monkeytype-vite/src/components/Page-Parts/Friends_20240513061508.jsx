      ...
      <div className="px-6 py-4">
        ...
        <div className="grid grid-cols-6 gap-4">
          <div className="col-span-3 bg-transparent border border-gray-800 rounded-lg py-3 px-4">
            ...
            <p className="text-white">{friendBattles.player1.email} {friendBattles.player1.score > friendBattles.player2.score ? <FaTrophy className="text-yellow-500 inline" /> : null}</p>
          </div>
          ...
          <div className="col-span-3 bg-transparent border border-gray-800 rounded-lg py-3 px-4">
            <p className="text-gray-300 font-bold">Player</p>
            <p className="text-white">{friendBattles.player2.email} {friendBattles.player2.score > friendBattles.player1.score ? <FaTrophy className="text-yellow-500 inline" /> : null}</p>
          </div>
          <div className="col-span-1 bg-transparent border border-gray-800 rounded-lg py-3 px-4">
            <p className="text-gray-300 font-bold">WPM</p>
          ...
          <div className="col-span-1 bg-transparent border border-gray-800 rounded-lg py-3 px-4">
            <p className="text-gray-300 font-bold">Overall Score</p>
            <p className="text-white text-center">{Math.round(computeOverallScore(friendBattles.player2))}</p>
          </div>
        </div>
      </div>
    </div>
