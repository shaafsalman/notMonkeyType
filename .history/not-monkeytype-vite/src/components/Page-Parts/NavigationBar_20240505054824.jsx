        ...
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="hidden lg:block lg:ml-6">
            <div className="flex space-x-4">
              <Link to="/Home/GameMenu" className={`text-white hover:'bg-indigo-800' hover:text-white rounded-md px-3 py-2 text-lg font-medium ${location.pathname === '/GameMenu' ? 'bg-indigo-800' : ' hover:bg-indigo-900 hover:text-white'}`}>
                <FaGamepad className="inline-block mr-1" />
                Game Menu
              </Link>
              <Link to="/Home/Leaderboards" className={`text-white hover:bg-indigo-800 hover:text-white rounded-md px-3 py-2 text-lg font-medium ${location.pathname === '/Leaderboards' ? 'bg-indigo-800' : 'hover:bg-indigo-900 hover:text-white'}`}>
                <FaTrophy className="inline-block mr-1" />
                Leaderboard
              </Link>
              <Link to="/Home/Friends" className={`text-white hover:bg-indigo-800 hover:text-white rounded-md px-3 py-2 text-lg font-medium ${location.pathname === '/Friends' ? 'bg-indigo-800' : 'hover:bg-indigo-900 hover:text-white'}`}>
                <FaUserFriends className="inline-block mr-1" />
                Friends
              </Link>
              <Link to="/Home/Scores" className={`text-white hover:bg-indigo-800 hover:text-white rounded-md px-3 py-2 text-lg font-medium ${location.pathname === '/Scores' ? 'bg-indigo-800' : 'hover:bg-indigo-900 hover:text-white'}`}>
                <FaListAlt className="inline-block mr-1" />
                Scores
              </Link>
              <Link to="/Home/settings" className={`text-white hover:bg-indigo-800 hover:text-white rounded-md px-3 py-2 text-lg font-medium ${location.pathname === '/settings' ? 'bg-indigo-800' : 'hover:bg-indigo-900 hover:text-white'}`}>
                <FaCog className="inline-block mr-1" />
                Settings
              </Link>
              <Link to="/Home/Profile" className={`text-white hover:bg-indigo-800 hover:text-white rounded-md px-3 py-2 text-lg font-medium ${location.pathname === '/Profile' ? 'bg-indigo-800' : 'hover:bg-indigo-900 hover:text-white'}`}>
                <FaUser className="inline-block mr-1" />
                Profile
              </Link>
              <Link to="Home/about" className={`text-white  hover:bg-indigo-800 hover:text-white rounded-md ml-10 px-20 py-2 text-lg font-medium ${location.pathname === '/about' ? 'bg-indigo-800' : 'hover:bg-indigo-900 hover:text-white'}`}>
