...
const InputButtonCard = ({ Title, InputTitle, ButtonTitle, onButtonClick, onCancel }) => { // Add onCancel prop
  ...
  return (
    ...
    <div className="max-w-lg rounded-lg p-10 overflow-hidden shadow-lg bg-gradient-to-br from-purple-500 to-indigo-600 transition duration-500 transform hover:scale-105">
