const NavigationBar = () => {
  ...
  return (
    <nav className="bg-gray-800 lg:rounded-lg lg:my-12 lg:mx-20">
        ...
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="hidden lg:block lg:ml-6">
            <div className="flex space-x-4">
              <Link to="/Game Menu" className="bg-gray-700 text-white rounded-md px-3 py-2 text-lg font-medium">Game Menu</Link>
              <Link to="/Leaderboard" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-lg font-medium">Leaderboard</Link>
              <Link to="/PersonalScores" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-lg font-medium">Scores</Link>
              <Link to="/settings" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-lg font-medium">Settings</Link>
              <Link to="/about" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-lg font-medium">About</Link>
              <Link to="/Profile" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-lg font-medium">Profile</Link>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Mobile Menu */}
      <div className={`${isOpen ? 'block' : 'hidden'} lg:hidden absolute top-16 inset-x-0 bg-gray-800 transition-all duration-300`}>
