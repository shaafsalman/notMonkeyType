      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="hidden lg:block lg:ml-6">
            ...
            <Link to="/GameMenu" className={`text-white hover:bg-purple-800 hover:text-white rounded-md px-3 py-2 text-lg font-medium ${location.pathname === '/GameMenu' ? 'bg-purple-900' : 'hover:bg-purple-900 hover:text-white'}`}>GameMenu</Link>
