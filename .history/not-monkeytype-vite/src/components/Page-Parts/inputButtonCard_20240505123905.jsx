...
const InputButtonCard = ({ Title, InputTitle, ButtonTitle, onButtonClick, onCancel, setVerificationCode }) => {
  ...
  const handleClick = () => {
    onButtonClick(verificationCodeInput); // Pass verification code input to the parent component
...
InputButtonCard.propTypes = {
  ...
  setVerificationCode: PropTypes.func.isRequired, // Add prop type for setVerificationCode function
};
