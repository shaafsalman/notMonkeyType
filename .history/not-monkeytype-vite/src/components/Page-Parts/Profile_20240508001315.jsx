            ...
            <div class="flex flex-col sm:flex-row w-max">
              <div class="sm:w-1/2 pr-4">
                ...
                <div class="flex flex-col items-start">
                  ...
                  <input type="password" id="current-password" value={currentPassword} onChange={(e) => setCurrentPassword(e.target.value)} class="w-40 border-gray-300 bg-white py-2 px-4 text-base text-gray-700 placeholder-gray-400 focus:outline-none mb-4 rounded-lg" />
                </div>
              </div>
