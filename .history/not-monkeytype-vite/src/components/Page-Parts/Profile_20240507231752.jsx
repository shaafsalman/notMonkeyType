      ...
      <div className="min-h-screen sm:px-8 xl:px-12">
        ...
        <div className="pt-4">
            ...
            <div className="flex flex-col items-start">
              <p className="text-white-600">Your email address is <strong>{email}</strong></p>
            </div>
            <hr className="mt-4 mb-8" />
            <p className="py-2 text-xl font-semibold">Password</p>
            <div className="flex flex-col items-start">
              <label htmlFor="current-password" className="text-sm text-white-500">Current Password</label>
              <input type="password" id="current-password" value={currentPassword} onChange={(e) => setCurrentPassword(e.target.value)} className="w-full border-white-300 bg-white py-2 px-4 text-base text-white-700 placeholder-white-400 focus:outline-none mb-4" />
              <label htmlFor="new-password" className="text-sm text-white-500">New Password</label>
              <input type="password" id="new-password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} className="w-full border-white-300 bg-white py-2 px-4 text-base text-white-700 placeholder-white-400 focus:outline-none mb-4" />
