...
const ProjectCard = ({ name, technologiesUsed,detail, githubLink }) => {
  ...
  return (
    <div className=" bg-gradient-to-br from-purple-500 to-indigo-600 lg:rounded-lg  xl:w-max	 shadow-lg rounded-lg overflow-hidden transform transition duration-300 hover:-translate-y-1">
      <div className="p-5">
        <div className="mt-4 ">
