...
function Results({ scores }) {
    ...
    const maxCombinedScore = Math.max(...combinedScores.map(score => score.combinedScore));

    // Find the winner based on the highest combined score
    const winner = combinedScores.find(score => score.combinedScore === maxCombinedScore);
