...
function Results({ scores }) {
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-gray-900 bg-opacity-50 z-50">
            <div className="max-w-screen-lg mx-4 rounded-lg overflow-hidden shadow-lg bg-gradient-to-br from-purple-500 to-indigo-600 transition duration-500 transform hover:scale-105 opacity-0 animate-fadeIn">
                <div className="p-6 sm:p-8 lg:p-10">
                    <div className="text-white text-4xl font-bold mb-8">Results</div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                        {combinedScores.map((score, index) => (
                            <div key={index} className="bg-white rounded-lg shadow-md p-6 flex flex-col justify-between opacity-0 animate-fadeIn delay-200">
                                <div>
