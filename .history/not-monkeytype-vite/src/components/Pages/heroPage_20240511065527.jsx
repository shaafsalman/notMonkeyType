  ...
  <div className="w-2/4 mt-60 bg-transparent backdrop-filter text-white p-4">
    <div className="flex justify-between items-center">
      <div className="flex items-center">
        <Link to="/Login" className="text-white hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium bg-gradient-to-r from-purple-500 to-indigo-600 mr-4">
          <FaGamepad className="inline-block mr-1" />
          Login
        </Link>
        <Link to="/Register" className="text-white hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium bg-gradient-to-r from-purple-500 to-indigo-600">
