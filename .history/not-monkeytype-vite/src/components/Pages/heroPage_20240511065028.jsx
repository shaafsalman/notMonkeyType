...
function HeroPage() {
  return (
    <div>
        ...
        <div class="fixed flex justify-center  rounded-lg  top-0 z-10 w-2/4 h-13   bg-transparent backdrop-filter backdrop-blur-md backdrop-saturate-120 bg-opacity-20  text-white p-4">
