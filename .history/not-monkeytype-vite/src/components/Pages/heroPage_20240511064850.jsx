...
function HeroPage() {
  return (
    <div>
        ...
        <div class="fixed flex justify-center rounded-lg  top-0 z-10 w-2/4 h-13 mt-80  bg-transparent backdrop-filter backdrop-blur-mdbg-opacity-20  text-white p-4">
