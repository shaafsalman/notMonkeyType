...
const NavigationBar = ({ isMobile, handleDurationChange, testDuration, testStarted, startTest, endTest, mode, difficultyLevel, setDifficultyLevel }) => {
    ...
    <nav className={`navbar ${isMobile ? 'flex flex-col items-center justify-center p-1' : 'flex justify-between items-center px-10 py-4'} bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-lg shadow-lg transition duration-300`}>
      {!isMobile && (
       ...
       {mode == "SinglePlayer" &&
        ...
        <ToggleComponent selectedValue={difficultyLevel} onToggleChange={setDifficultyLevel} />
      </div>
         }
