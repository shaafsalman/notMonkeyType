...
const MultiPlayerForm = ({ joinRoom, createRoom, roomCode, input }) => {
          ...
          <div className="w-1/2 px-11 py-40 mr-30">
            ...
            {generatedCode && !showInput && (
              <div>
                ...
                <button onClick={handleRegenerateCode} className="w-max px-4 py-2 mx-10 bg-indigo-800 hover:bg-indigo-900 text-white rounded">
                  Regenerate Code
                </button>
