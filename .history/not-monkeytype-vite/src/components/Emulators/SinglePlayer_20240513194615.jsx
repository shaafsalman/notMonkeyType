...
import paragraphGenerator from './../Utility/paragraphGenerator';
...
const SinglePlayer = () => {
  ...
  const [testText,seTestText] = useState("Betty decided to write a short story Betty decided to write a short story Betty decided to write a short story Betty decided to write a short story");
  ...
  const fetchParagraph = async () => {
    try {
      const paragraph = await paragraphGenerator(difficultyLevel);
