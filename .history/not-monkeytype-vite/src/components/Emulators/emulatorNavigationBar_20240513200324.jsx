...
const NavigationBar = ({ isMobile, handleDurationChange, testDuration, testStarted, startTest, endTest, mode, roomCode, setDifficultyLevel}) => {
  ...
  return (
    <nav className={`navbar ${isMobile ? 'flex flex-col items-center justify-center p-1' : 'flex justify-between items-center px-5 py-4'} bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-lg shadow-lg transition duration-300`}>
      {!isMobile && (
        <div className="div">
           <div className="flex">
