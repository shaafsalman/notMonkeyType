...
const socket = io('http://192.204.237.7:8080'); 
...
const MultiPlayer = () => {
  ...
  const [testText] = useState("The marvel cinematic universe is an american media franchise and shared universe centered on a series of superhero films produced by marvel studios. The mcu has revolutionized modern cinema becoming a cultural phenomenon");
