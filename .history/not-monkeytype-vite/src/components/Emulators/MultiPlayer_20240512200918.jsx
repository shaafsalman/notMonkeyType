...
import TimerCard from './TimerCard'; // Import the TimerCard component
...
const MultiPlayer = () => {
  ...
  const [showTimerCard, setShowTimerCard] = useState(false); // State to control TimerCard visibility
