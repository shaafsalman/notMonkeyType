...
const MultiPlayerForm = ({ joinRoom, createRoom, roomCode, input, setFinalCode }) => {
  ...
  const handleCreateClick = () => {
    ...
    createRoom();
    setShowInput(false);
    setFinalCode(newCode); // Set the final code when generating room
  };
          ...
          <div className="w-1/2 px-8 py-40 mr-30">
            ...
            {generatedCode && !showInput && (
              <div>
                ...
                <div className="flex-auto w-max">
                  ...
                  <button onClick={handleEnterRoom(roomCode)} className="w-max px-4 py-2 bg-indigo-800 hover:bg-indigo-900 text-white rounded">
                    Enter Room
                  </button>
                </div>
              </div>
            ...
            {showInput && (
              <div>
                ...
                />
                <button onClick={handleEnterRoom(from input)} className="w-max px-4 py-2 bg-indigo-800 hover:bg-indigo-900 text-white rounded">
                  Enter Room
                </button>
              </div>
            )}
