  ...
  useEffect(() => {
    const fetchParagraph = async () => {
      try {
        ...
        setTestText("The marvel cinematic universe is an american media franchise and shared universe centered on a series of superhero films produced by marvel studioz. The mcu has revolutionized modern cinema becoming a cultural phenomenon with its beloved characters as the MCU expands it introduces new heroes and villains to inspire audiences to believe in the extraordinary and embrace the power of imagination");
