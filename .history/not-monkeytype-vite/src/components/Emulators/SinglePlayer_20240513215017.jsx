  ...
  useEffect(() => {
    const fetchParagraph = async () => {
      try {
        ...
        setTestText("The marvel cinematic universe is an american media franchise and shared universe centered on a series of superhero films produced by marvel studioz. The mcu has revolutionized modern cinema becoming a cultural phenomenon ");
