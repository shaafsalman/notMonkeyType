...
const SinglePlayer = () => {
  ...
  useEffect(() => {
    let timer;
    if (testStarted && timeRemaining > 0 && userInput !== testText) { // Add userInput !== testText condition
      timer = setInterval(() => {
        setTimeRemaining((prev) => prev - 1);
      }, 1000);
    } else if ((timeRemaining === 0 || userInput === testText) && testStarted) { // Also add userInput === testText condition
      endTest();
    }
