...
const SinglePlayer = () => {
  ...
  {testStarted ? (
    <button className="className="mx-6 my-4 px-6 py-3 bg-indigo-800 hover:bg-indigo-900 text-white rounded-lg transition duration-300 text-center onClick={endTest}>Stop</button>
  ) : (
    <button className="className="mx-6 my-4 px-6 py-3 bg-indigo-800 hover:bg-indigo-900 text-white rounded-lg transition duration-300 text-center"></nav>" onClick={startTest}>Start</button>
  )}
</nav>
