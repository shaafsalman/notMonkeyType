...
const SinglePlayer = () => {
  ...
  return (
    <div className="singlePlayer">
      ...
      <nav className="flex justify-between items-center px-10 py-4 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-lg shadow-md">
  <Link to="/home" className="px-6 py-3 bg-indigo-800 hover:bg-indigo-900 text-white rounded-lg transition duration-300 text-center">
    Back to Menu
  </Link>
  <h1 className="text-white text-xl font-bold">notMonkeyType</h1>
  <div className="ml-auto">
    <div className="flex items-center">
      <div className="text-white">Mode: SinglePlayer</div>
      <div className="ml-4">
        <select
          className="px-4 py-2 border border-gray-300 rounded-lg outline-none focus:border-gray-400 bg-white text-black"
      ...
      <div className="ml-4">
        {testStarted ? (
          <button className="px-6 py-3 bg-indigo-800 hover:bg-indigo-900 text-white rounded-lg transition duration-300" onClick={endTest}>
            Stop
          </button>
        ) : (
          <button className="px-6 py-3 bg-indigo-800 hover:bg-indigo-900 text-white rounded-lg transition duration-300" onClick={startTest}>
            Start
          </button>
        )}
      </div>
