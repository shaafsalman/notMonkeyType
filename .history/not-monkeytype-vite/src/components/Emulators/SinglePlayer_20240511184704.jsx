...
const SinglePlayer = () => {
  ...
  return (
    <div className="singlePlayer">
      ...
      <nav className="navbar flex justify-end items-center px-10 py-2 bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-lg shadow-lg transition duration-300">
