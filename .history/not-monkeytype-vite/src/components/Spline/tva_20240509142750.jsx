...
const TVA = () => {
  return (
    <div className="absolute top-0 left-0 w-full h-full bg-gray-200 flex justify-center items-center">
      <div className="w-4/5 max-w-lg flex rounded-lg overflow-hidden bg-white bg-opacity-50 backdrop-filter backdrop-blur-md backdrop-saturate-150 shadow-lg h-70vh md:h-60vh">
