  ...
  return (
    <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center">
      <div className="w-4/5 max-w-lg flex rounded-lg overflow-hidden bg-white bg-opacity-50 backdrop-filter backdrop-blur-md backdrop-saturate-150 shadow-lg h-60vh min-h-70vh">
        <div className="w-1/2 px-10 py-10 md:py-40 mr-8 md:mr-30">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">MultiPlayer</h1>
          <input
            type="text"
            placeholder="Enter Room ID"
            className="w-full px-2 py-2 mb-6 border border-gray-300 rounded focus:outline-none focus:border-blue-500"
          />
          <div className="flex">
