          ...
          <div className="w-1/2 px-11 py-40 mr-30">
            ...
            {generatedCode && !showInput && (
              <div className="bg-white p-4 rounded shadow-md mt-4">
                <p className="text-blue-500 mb-4">Room Code: {generatedCode}</p>
                <button onClick={handleRegenerateCode} className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
                  Regenerate Code
                </button>
              </div>
            )}
