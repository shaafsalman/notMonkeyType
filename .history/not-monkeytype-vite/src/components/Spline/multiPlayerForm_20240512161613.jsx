        ...
        <div className="pr-10m x-10">
          <div className="w-1/2 px-11 py-40 mr-30">
            ...
            {generatedCode && !showInput && (
              ...
              <p className="text-white text-xl mr-4">Room Code: {generatedCode}</p>
              <button onClick={handleRegenerateCode} className="px-4 py-2 bg-indigo-800 hover:bg-indigo-900 text-white rounded">
                Regenerate Code
              </button>
            </div>
            )}
