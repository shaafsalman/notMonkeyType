      ...
      <div className="w-3/5 flex rounded-lg overflow-hidden shadow-lg bg-transparent backdrop-filter backdrop-blur-md backdrop-saturate-150 bg-opacity-20 transition duration-500 transform hover:scale-105 h-60vh min-h-60vh">
        <div className="pr-10m x-10">
          <div className="w-1/2 px-11 py-40 mr-30">
            ...
            <div className="flex w-max pr-10">
              <button onClick={handleCreateClick} className="w-max px-4 py-2 mr-2  bg-indigo-800 hover:bg-indigo-900 text-white rounded ">
                Create Room
              </button>
              <button onClick={handleJoinClick} className="w-max px-4 py-2  bg-indigo-800 hover:bg-indigo-900 text-white rounded ">
                Join Room
              </button>
            </div>
            {generatedCode && !showInput && (
              <div>
                <p className="text-white mb-4">Room Code: {generatedCode}</p>
