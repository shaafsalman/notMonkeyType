const GenreDescription = (level) => {
  ...
  const descriptions = {
    beginner: {
      marvel: [
        "The marvel cinematic universe is an american media franchise and shared universe centered on a series of superhero films produced by marvel studios. The mcu has revolutionized modern cinema becoming a cultural phenomenon with its beloved characters as the MCU expands it introduces new heroes and villains to inspire audiences to believe in the extraordinary and embrace the power of imagination",
      ...
      starwars: [
        ...
        "The franchise depicts the adventures of characters a long time ago in a galaxy far, far away",
        "Humans and many species of aliens co-exist with droids which may be programmed for personal assistance or battle",
      ],
      cars: [
        "Cars are a mode of transportation powered by internal combustion engines or electric motors",
        "They come in various shapes and sizes and models serving different purposes from commuting to racing",
        "People customize and personalize cars according to their preferences which reflect individual styles and tastes",
      ],
      japanesecars: [
        "Japanese 90s cars were popular cars made in Japan during the 1990s",
        "They were known for their reliability and affordability, appealing to many drivers",
        "Models like the Toyota Corolla and Honda Civic became household names, trusted for their performance and longevity",
      ],
    },
    intermediate: {
      marvel: [
