  ...
  return (
    <div className="relative w-full mt-4 rounded-md border h-10 p-1 bg-gray-200">
      ...
      <div className="absolute bottom-0 w-full">
        <span className={`${selectedValue === 'beginner' ? 'left-1/3' : selectedValue === 'intermediate' ? 'left-1/2' : 'left-2/3'} text-gray-800 bg-white shadow text-sm flex items-center justify-center w-1/3 h-[1.88rem] transition-all duration-300 ease-linear`}>
