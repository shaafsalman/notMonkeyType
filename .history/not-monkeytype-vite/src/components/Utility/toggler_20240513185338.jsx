  ...
  return (
    <div className="relative w-full mt-4 rounded-md border h-10 p-1 bg-transparent">
      <div className="flex w-full">
        <div className={`w-1/3 flex justify-center items-center cursor-pointer  ${selectedValue === 'beginner' ? 'bg-indigo-300' : 'bg-transparent'}`} onClick={() => onToggleChange('beginner')}>
          <button className="py-2 px-4 rounded-md text-sm font-medium">
            Beginner
          </button>
        </div>
        <div className={`w-1/3 flex justify-center items-center cursor-pointer ${selectedValue === 'intermediate' ? 'bg-indigo-300' : 'bg-transparent'}`} onClick={() => onToggleChange('intermediate')}>
          <button className="py-2 px-4 rounded-md text-sm font-medium">
            Intermediate
          </button>
        </div>
        <div className={`w-1/3 flex justify-center items-center cursor-pointer ${selectedValue === 'expert' ? 'bg-indigo-300' : 'bg-transparent'}`} onClick={() => onToggleChange('expert')}>
          <button className="py-2 px-4 rounded-md text-sm font-medium">
            Expert
          </button>
        </div>
