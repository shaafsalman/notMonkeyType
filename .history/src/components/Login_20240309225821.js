...
import logoImage from '../assests/Logo2Transparent.png'; // Adjust the path as necessary
import loginGIF from '../assests/loginGIF.gif'; // Adjust the path as necessary
import staticLogin from '../assests/StaticLogin.png'; // Adjust the path as necessary
