...
import logoImage from './assets/Logo2Transparent.png'; // Adjust the path as necessary
import loginGIF from './assets/loginGIF.gif'; // Adjust the path as necessary
import staticLogin from './assets/StaticLogin.png'; // Adjust the path as necessary
