...
const { MultiGameSession } = require("./models/multiGameSession"); // Import the MultiGameSession model
...
const multiGameSessionController = require("./routes/multiGameSessionController"); // Import the multiGameSessionController
