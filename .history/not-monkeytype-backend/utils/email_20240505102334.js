...
const sendVerificationEmail = async (email, firstName, lastName, verificationCode) => {
    try {
        ...
        <div style="max-width: 1000px; background-color: #ffffff; padding: 24px; box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.1); border-radius: 12px; color: #212529;">
            ...
            <footer style="background-color: #ffffff; padding: 10px; border-top: 1px solid #dee2e6; border-radius: 12px; display: flex; justify-content: space-between; align-items: center;">
    
                <!-- Column 1: Image -->
                <div style="flex-grow: 1;">
                    <img src="https://i.ibb.co/p0KpHg3/footer.png" alt="Footer Image" style="max-width: 40%; height: auto; border-radius: 8px;" />
                </div>
