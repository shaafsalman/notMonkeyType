...
const sendVerificationEmail = async (email, firstName, lastName, verificationCode) => {
    ...
    <div style="flex-grow: 1; display: flex; justify-content: flex-end; align-items: center;">
        ...
        <a href="#" style="text-decoration: none; color: #343a40; margin-left: 8px;"><img src="https://simpleicon.com/wp-content/uploads/facebook1-256x256.png" alt="Facebook" style="width: 24px; height: 48px; vertical-align: middle;" /></a>
